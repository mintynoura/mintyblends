...
import io.github.mintynoura.mintyblends.registry.ModBlocks;import net.minecraft.core.registries.Registries;
...
public class ModConfiguredFeatures {
    ...
    public static SimpleBlockConfiguration catnipFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.CATNIP));
    public static SimpleBlockConfiguration culinaryHerbFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.CULINARY_HERB));
    public static SimpleBlockConfiguration cureflowerFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.CUREFLOWER));
    public static SimpleBlockConfiguration medicinalHerbFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.MEDICINAL_HERB));
    public static SimpleBlockConfiguration mintFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.MINT));
    public static SimpleBlockConfiguration sagebrushFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.SAGEBRUSH));
    public static SimpleBlockConfiguration silentFlowerFeature = new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.SILENT_FLOWER));
