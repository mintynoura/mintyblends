    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter exporter) {
        return new RecipeGenerator(wrapperLookup, exporter) {
            ...
            public void generate() {
                ...
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.MINT.asItem()), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), ModItems.MINT_LEAVES, 4).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.CATNIP.asItem()), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), ModItems.CATNIP_LEAVES, 4).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.MEDICINAL_HERB.asItem()), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), ModItems.MEDICINAL_LEAVES, 4).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.CULINARY_HERB.asItem()), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), ModItems.CULINARY_LEAVES, 4).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.SAGEBRUSH.asItem()), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), ModItems.SAGEBRUSH_LEAVES, 4).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));

                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModItems.CUREFLOWER), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), Items.BLACK_DYE, 2).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModItems.RENDFLOWER), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), Items.PURPLE_DYE, 2).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
                CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.ofItem(ModBlocks.SILENT_FLOWER), Ingredient.fromTag(holderGetter.getOrThrow(CommonTags.TOOLS_KNIFE)), Items.LIGHT_BLUE_DYE, 2).build(withConditions(exporter, ResourceConditions.anyModsLoaded("farmersdelight")));
            }
        };
    }
